...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_products_edition_type" AS ENUM('limited', 'open', 'ap');
  CREATE TYPE "public"."enum_products_status" AS ENUM('draft', 'published', 'sold_out');
  ...
  CREATE TABLE "products" (
  	...
  	"edition_type" "enum_products_edition_type" DEFAULT 'limited' NOT NULL,
  	"edition_total" numeric,
  	"edition_sold" numeric DEFAULT 0,
  	"featured" boolean DEFAULT false,
  	"order" numeric DEFAULT 0,
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_products_edition_type";
